document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateDashboard(inquiriesCount, bookingsCount, usersCount) {
        document.getElementById("total-inquiries").textContent = inquiriesCount;
    ...
    async function loadInquiries() {
        ...
        try {
            ...
            updateDashboard(newCount, document.getElementById("total-bookings").textContent, document.getElementById("total-users").textContent);

            tbody.querySelectorAll(".delete").forEach(btn => {
                btn.addEventListener("click", async () => {
                    const id = btn.dataset.id;
                    if (!confirm("Delete this inquiry?")) return;
                    const delRes = await fetch(`http://localhost:3000/api/inquiries/${id}`, { method: "DELETE" });
    ...
    async function loadBookings() {
        ...
        try {
            ...
            updateDashboard(document.getElementById("total-inquiries").textContent, pendingCount, document.getElementById("total-users").textContent);
    ...
    async function loadUsers() {
        ...
        try {
            ...
            updateDashboard(document.getElementById("total-inquiries").textContent, document.getElementById("total-bookings").textContent, usersCount);
    ...
    async function loadGallery() {
        ...
        try {
            ...
            // *** UPDATED THIS CODE ***
            // Cleaned up the stray HTML tags
            ...
            container.querySelectorAll(".delete").forEach(btn => {
                btn.addEventListener("click", async () => {
                    ...
                    const res = await fetch(`http://localhost:3000/api/gallery/${id}`, { method: "DELETE" });
        ...
        try {
            ...
            container.querySelectorAll(".delete").forEach(btn => {
                btn.addEventListener("click", async () => {
                    ...
                    const res = await fetch(`http://localhost:3000/api/testimonials/${id}`, { method: "DELETE" });
    ...
    // ⬇️ YOUR LIVE BACKEND URL (I updated this for you)
    ...
    async function loadInquiries() {
        ...
        try {
            ...
            // Safe check for elements before updating dashboard
